    ...
    <div style={{ backgroundColor: '#073B73', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <AppBar position="static" sx={{ backgroundColor: '#073B73', boxShadow: 'none', width: '100%' }}>
        <Toolbar sx={{ justifyContent: 'center' }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <img src="/assets/rocket-logo.png" alt="Reviso Logo" style={{ height: 150, marginRight: 16, paddingTop: 25 }} />
          </Box>
        </Toolbar>
      </AppBar>
      ...
      <Grid container spacing={2} sx={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center' }}>
        ...
        <Grid item xs={12} sm={3} sx={{ textAlign: 'center', color: 'white', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <Box sx={{ backgroundColor: '#f974a6', height: '300px', width: '100%', borderRadius: 4, mb: 2, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Typography variant="h6">Your favorite study tool</Typography>
          </Box>
          <Box sx={{ backgroundColor: '#ffa5c6', height: '300px', width: '100%', borderRadius: 4, mt: 2, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Grid item xs={12} sm={5} sx={{ textAlign: 'center', color: 'white' }}>
          <Box sx={{ backgroundColor: '#79c9fa', borderRadius: 8, p: 4, position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', height: '650px' }}>
            <Typography 
              variant="h4" 
              sx={{ 
                color: '#f974a6', 
        ...
        {/* Right Section */}
        <Grid item xs={12} sm={3} sx={{ textAlign: 'center', color: 'white', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <Box sx={{ backgroundColor: '#ffa5c6', height: '300px', width: '100%', borderRadius: 4, mb: 2, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
